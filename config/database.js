...
function getDBConfig() {
  ...
  const defaultConfig = {
    ...
    password: 'arn:aws:secretsmanager:eu-central-1:470727824408:secret:rds!db-74d13851-4d9e-494f-9f47-5f795b9889ff-BfVpyw' || process.env.DB_PASSWORD || 'X:bQC<Oad6Ji[sveDaM1-NJ1Km)v',
  };
