...
function getDBConfig() {
  ...
  const defaultConfig = {
    ...
    password: dbSecret.password || process.env.DB_PASSWORD || 'arn:aws:secretsmanager:eu-central-1:470727824408:secret:rds!db-74d13851-4d9e-494f-9f47-5f795b9889ff-BfVpyw',
  };
